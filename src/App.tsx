...
function Content() {
    ...
    return (
        <div className="flex flex-col gap-8 max-w-lg mx-auto">
            ...
            <p>
                Edit <code className="text-sm font-bold font-mono bg-slate-200 dark:bg-slate-800 px-1 py-0.5 rounded-md">convex/myFunctions.ts</code>{' '}
                to change your backend
            </p>
            <p>
                Edit <code className="text-sm font-bold font-mono bg-slate-200 dark:bg-slate-800 px-1 py-0.5 rounded-md">src/App.tsx</code> to change
                your frontend
            </p>
